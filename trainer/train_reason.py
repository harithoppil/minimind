...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_weight", default="reason", type=str, help="Prefix for saved weight files"
    )
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="dataset/r1_mix_1024.jsonl",
        help="Reasoning distillation data path",
    )
    parser.add_argument(
        "--from_weight", default="dpo", type=str, help="Base weight to train from, default: dpo"
    )
    parser.add_argument(
        "--from_resume",
        default=0,
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="MiniMind-Reasoning", help="wandb project name"
    )
    parser.add_argument(
        "--use_compile",
        default=0,
