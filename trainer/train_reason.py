...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_weight", default="reason", type=str, help="保存权重的前缀名"
    )
    ...
    parser.add_argument(
        "--from_weight", default="dpo", type=str, help="基于哪个权重训练，默认dpo"
    )
    parser.add_argument(
        "--from_resume",
        default=0,
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="MiniMind-Reasoning", help="wandb项目名"
    )
    parser.add_argument(
        "--use_compile",
        default=0,
